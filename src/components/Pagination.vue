  ...
  <nav aria-label="Page navigation example">
    <ul class="pagination d-flex justify-content-center overflow-auto" style="text-align: center;">
      ...
      <template v-if="pageCount <= 5">
        <li v-for="page in pageCount" :key="page" :class="{ 'page-item': true, 'active': page === currentPage }">
      ...
      <template v-else>
        ...
        <template v-if="pageCount - startingPage >= 4">
          <li v-for="index in 5" :key="index" :class="{ 'page-item': true, 'active': startingPage + index - 1 === currentPage }">
        ...
        <template v-else>
          <li v-for="index in pageCount - startingPage + 1" :key="index" :class="{ 'page-item': true, 'active': startingPage + index - 1 === currentPage }">
            <a class="page-link" href="#" @click="goToPage(startingPage + index - 1)">
              {{ startingPage + index - 1 }}
            </a>
          </li>
